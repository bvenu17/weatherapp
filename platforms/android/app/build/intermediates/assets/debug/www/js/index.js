...
var app = {
    ...
    onDeviceReady: function() {
        ...
        $.getJSON('http://api.openweathermap.org/data/2.5/weather?q=Chennai&units=metric&appid=b9424d2182aaf5d668ebedbcea30a439',function (data) {
...
//  var variable_dat = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('dat'), Blockly.Variables.NAME_TYPE);
...
Blockly.Blocks['logic'] = {
  init: function() {
    this.appendDummyInput()
      //  .appendField(new Blockly.FieldVariable("weather"), "dat");
        .appendField("switch");
